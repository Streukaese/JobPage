...
<body class="h-full">
        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <!-- Verbunden mit "layout.blade.php" und regelt hintergrund der ausgewählten seite(button) -->
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              @auth
                      {{-- /logout == Coupled with Routes(web.php) --}}
                    <form method="POST" action="/logout">
                      @csrf

                      <x-form-button>Log Out</x-form-button>
                    </form>
              {{-- <x-nav-link href="/logout">Log Out</x-nav-link> || BEFORE form --}}
              {{-- <x-nav-link href="/login" :active="request()->is('login')">Log Out</x-nav-link> || For creating a encrotac to log out the user --}}
              @endauth
            </div>
        </div>
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            ...
            <div class="text-sm font-medium leading-none text-gray-400">bleeseds@gmail.com</div>
          </div>
  ...
  <main>
    ...
    {{ $slot }} <!-- Hier kommt der Inhalt der seite (h1 sowie texte) -->
    </div>
  </main>
</div>
